...
<?php
		...
		if(isset($_POST['Submit']))
		{
			...
			$phone1 = $_POST['phone'];
				...
				$sql = "INSERT INTO register(Fname,Lname,Package_id,Address,Pincode,email,Mobile) VALUES ('$Fa','$La','$P_id','$address',$Pincode,'$email','$phone1')";
				$result = mysqli_query($conn,$sql);
				if($result)
				{
					echo "<script>
					alert('You have been registered successfully. We will contact you shortly!');
					window.location.assign('fitx.html')
					</script>";
