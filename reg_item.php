	...
	<script type="text/javascript">
		function validate()
		{
			...
			if(document.myForm.size.value == "") {
	            ...
	            document.getElementById("p11").innerHTML="Please enter Size";
...
<?php
		...
		if(isset($_POST['Submit']))
		{
			...
			$size = $_POST['size'];
				...
				$sql = "INSERT INTO register1(Fname,Lname,Package_id,Address,Pincode,email,Mobile,Size) VALUES ('$Fa','$La','$P_id','$address',$Pincode,'$email','$phone1','$size')";
				$result = mysqli_query($conn,$sql);
				if($result)
				{
					echo "<script>
					alert('You have ordered the product. We will contact you shortly!');
				...
				{
					echo '<script type="text/JavaScript"> alert("Cannot Buy wait for some time");</script>';
...
<body>
	...
	<div class="container">
		<form method="post" action="reg_item.php" onsubmit="return(validate())" name="myForm">	
			...
			<div class="form-field col-lg-6">
				...
				<div class="form-field col-lg-6">
					<input id="id" class="input-text" type="text" name="size">
					<label for="name" class="label" style="color:black;font-family: 'Kalam', cursive;font-size:20px;">Size(L/M/S)</label>
				</div>
				<div class="form-field col-lg-10">
				 <input id="id" class="input-text" type="text" name="Address">
		             <label for="name" class="label" style="color:black;font-family: 'Kalam', cursive;font-size:20px;position:relative;top:40px;left:-200px;">Address</label>
	             </div>
				<br><br>
