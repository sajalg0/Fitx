...
<label class="l">Membership Id:</label>
<input type="text" name="t1" class="i"><br><br><br>
<label class="l">Membership Name:</label>
<input type="text" name="t2" class="i"><br><br><br>
<label class="l">Membership Description:</label>
<input type="text" name="t3" class="i" ><br><br><br>
<label class="l">Membership Description(line2):</label>
<input type="text" name="t5" class="i" ><br><br><br>
<label class="l">Membership Description(line3):</label>
<input type="text" name="t6" class="i" ><br><br><br>
<label class="l">Membership Price:</label>
...
<?php
			...
			if(isset($_POST['ADD']))
			{
				...
				else
				{
					...
					$sql = "INSERT INTO shopping(id,name,image,price,discount,line2,line3) VALUES ($id,'$pname','$file',$pp,'$pdes','$pdes1','$pdes2')";
