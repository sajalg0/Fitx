...
<table class="styled-table">
    <thead>
        <tr style="	font-family: 'Kalam', cursive;font-size:18px;">
			...
			<th>Item Description(Line2)</th>
			<th>Item Description(Line3)</th>
            <th>Item Price</th>
			<th>Item Image</th>
			<th>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Control</th>
        </tr>
    ...
    <tbody>
	   ...
	   {?>
		   ...
		   <td><a href="update_popitem.php?id1=<?php echo $row['id'];?>" class="btn btn-success" name="s" data-toggle="modal">Update</a></td>
		   </form>
		   </tr>
	  <?php }
		   ?>
